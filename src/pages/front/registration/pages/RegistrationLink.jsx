...
const RegistrationLink = () => {
    ...
    const buildRegistrationDataFromDetail = useCallback((raw) => {
        ...
        const applicants = (raw.details || []).map((d) => ({
            ...
            emergencyPhoneCountryCode: d.emergencyPhoneCountryCode || null,
            teamGroup: d.teamGroup || null,
            extraShirts: Object.fromEntries((d.extraShirts || []).map((sh) => [sh.category, sh])),
            idNo: d.idNo || "",
