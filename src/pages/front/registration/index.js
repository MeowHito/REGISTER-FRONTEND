export { default as RegistrationInfo } from './pages/RegistrationInfo';
export { default as RegistrationDetail } from './pages/RegistrationDetail';
export { default as RegistrationPayment } from './pages/RegistrationPayment/index';
